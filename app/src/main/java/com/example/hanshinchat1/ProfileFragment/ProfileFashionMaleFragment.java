...
public class ProfileFashionMaleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.profile_fashion_male_fragment, container, false);

        ProfileFashion1 = view.findViewById(R.id.fashion_male_fragment1);
        ProfileFashion2 = view.findViewById(R.id.fashion_male_fragment2);
        ProfileFashion3 = view.findViewById(R.id.fashion_male_fragment3);
        ProfileFashion4 = view.findViewById(R.id.fashion_male_fragment4);
