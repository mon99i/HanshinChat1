...
public class Simulation9 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                questionScore = 4;
                SimulationScoreManager.setQuestionScore(Simulation9.class, questionScore);
            }
        });
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int previousQuestionScore = SimulationScoreManager.getQuestionScore(Simulation8.class);
